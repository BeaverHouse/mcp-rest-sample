...
from api.rest import body_router, family_router

# Create FastAPI application with metadata
app = FastAPI(
    root_path="/api",
    title="FastAPI Sample Server",
    description="Sample server for testing the FastAPI framework + MCP Server integration",
    version="0.0.1",
)
